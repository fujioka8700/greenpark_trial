...
// 花の色で植物を検索する
Route::get('/plants/search-colors', [PlantController::class, 'searchColors'])->name('search.colors');
...
Route::apiResource('comments', \App\Http\Controllers\CommentController::class, ['only' => ['index', 'store', 'destroy']]);
